...
(function() {
	...
	jook.readConfig = function(options) {
		var fs = require('fs');
		var path = require('path');

		var file = path.join(path.dirname(fs.realpathSync(__filename)), jook.options.files.config);
